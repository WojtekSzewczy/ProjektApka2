...
public final class FragmentMainBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView rejestrujTextView;

  private FragmentMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull EditText editTextNumberPassword, @NonNull EditText editTextTextEmailAddress,
      @NonNull TextView rejestrujTextView) {
    this.rootView = rootView;
    this.button = button;
    this.editTextNumberPassword = editTextNumberPassword;
    this.editTextTextEmailAddress = editTextTextEmailAddress;
    this.rejestrujTextView = rejestrujTextView;
  }
  ...
  public static FragmentMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rejestrujTextView;
      TextView rejestrujTextView = ViewBindings.findChildViewById(rootView, id);
      if (rejestrujTextView == null) {
        break missingId;
      }

      return new FragmentMainBinding((ConstraintLayout) rootView, button, editTextNumberPassword,
          editTextTextEmailAddress, rejestrujTextView);
    }
